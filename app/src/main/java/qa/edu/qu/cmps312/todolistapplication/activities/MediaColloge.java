...
public class MediaColloge extends AppCompatActivity implements DialogFragment.DialogFragmentInteraction, CustomAdapter.AdapterInteraction{

private FloatingActionButton addBtn;
private ArrayList<Tutorial> tutorialMedia;
...
protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_media_colloge);
        if (findViewById(R.id.fragment_container) != null) {
        mPane = true;
        } else
        mPane = false;

        addBtn = findViewById(R.id.add_btn2);
...
public void onClick(View v) {
        ...
        recyclerView = findViewById(R.id.mColList);
...
public ArrayList<Tutorial> getAllTodo() {
        ...
        tutorialMedia = new ArrayList<>();
        // tutorialMedia.add(new Tutorial("a","a","a","A"));
