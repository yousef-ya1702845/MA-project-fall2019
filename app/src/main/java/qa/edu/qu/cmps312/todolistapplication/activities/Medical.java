...
public class Medical extends AppCompatActivity implements DialogFragment.DialogFragmentInteraction, CustomAdapter.AdapterInteraction{

    private FloatingActionButton addBtn;
    private ArrayList<Tutorial> tutorialsM;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addBtn = findViewById(R.id.add_btn4);
    ...
    public ArrayList<Tutorial> getAllTodo() {
        ...
        tutorialsM = new ArrayList<>();
        // tutorialsM.add(new Tutorial("a","a","a","A"));
